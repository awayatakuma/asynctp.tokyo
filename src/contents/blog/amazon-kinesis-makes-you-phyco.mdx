---
title: 'Amazon Kinesis makes you phyco: an introduction to the MultiLang Daemon Labyrinth'
date: '2024-06-29'
...
## Amazon Kinesis makes you phyco: an introduction to the MultiLang Daemon Labyrinth
...
On paper, Kinesis seemed like the perfect fit. High throughput? Check. Low latency? Check. Scalability? Check. With our application written in C++ and AWS offering an SDK for C++, I initially thought we had struck gold. The prospect of seamlessly integrating Kinesis into our existing C++ codebase was enticing.
...
> This is the structure if you want synthesis C++ application and MultiLangDaemon. As there is no KCL for C++, you'll need to develop all components in which C++ logos are pasted.
...
[^2]: [Developing a Kinesis Client Library Consumer in Python](https://docs.aws.amazon.com/streams/latest/dev/kcl2-standard-consumer-python-example.html)
